...
<?php echo $this->Form->create('Atividade'); ?>
	...
	<?php
		echo $this->Form->input('idatividade');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Atividade.idatividade')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Atividade.idatividade'))); ?></li>
